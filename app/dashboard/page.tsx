                  ...
                  >
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <YAxis dataKey="category" type="category" stroke="#64748b" width={window.innerWidth < 640 ? 60 : 80} fontSize={9} />
                        <Tooltip
                          contentStyle={{
                            backgroundColor: "white",
                            border: "1px solid #e2e8f0",
            ...
            <Card className="shadow-lg border-2 border-slate-200 bg-white">
              <Tabs defaultValue="programs" className="w-full">
                <CardHeader className="border-b-2 border-slate-100 pb-0 bg-gradient-to-r from-slate-50 to-white">
                  <TabsList className="bg-white border border-slate-200 p-1 h-auto shadow-sm w-full sm:w-auto">
                    <TabsTrigger
                      value="programs"
                      className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-teal-500 data-[state=active]:to-teal-600 data-[state=active]:text-white data-[state=active]:shadow-md text-xs sm:text-sm font-bold px-4 sm:px-8 py-2.5 rounded transition-all flex-1 sm:flex-initial"
                    >
                      <Calendar className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" />
                      <span className="hidden sm:inline">Recent </span>Programs
                    </TabsTrigger>
                    <TabsTrigger
                      value="expenses"
                      className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-500 data-[state=active]:to-orange-600 data-[state=active]:text-white data-[state=active]:shadow-md text-xs sm:text-sm font-bold px-4 sm:px-8 py-2.5 rounded transition-all flex-1 sm:flex-initial"
                    >
